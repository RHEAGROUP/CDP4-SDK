        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(requestedDataModelVersion.ToString(3))
            {
                ...
                case "1.1.0":
                    ...
                    if (quantityKindFactor.ExcludedDomain.Count > 0)
                    {
                    ...
                    if (quantityKindFactor.ExcludedPerson.Count > 0)
                    {
                ...
                case "1.3.0":
                    ...
                    if(quantityKindFactor.Actor.HasValue)
                    {
                        writer.WriteStringValue(quantityKindFactor.Actor.Value);
                    }
                    else
                    {
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "modifiedon":
                    ...
                    break;
                case "quantitykind":
                    if(!AllowedVersionsPerProperty["quantityKind"].Contains(requestedVersion))
                    {
                        return;
                    }
