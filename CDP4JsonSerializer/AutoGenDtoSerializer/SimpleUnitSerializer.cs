...
namespace CDP4JsonSerializer
{
    ...
    using SimpleUnit = CDP4Common.DTO.SimpleUnit;
    ...
    public class SimpleUnitSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        /// <exception cref="ArgumentException">If the provided <paramref name="thing" /> is not an <see cref="SimpleUnit" /></exception>
        /// <exception cref="NotSupportedException">If the provided <paramref name="requestedDataModelVersion" /> is not supported</exception>
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            if (thing is not SimpleUnit simpleUnit)
            {
                throw new ArgumentException("The thing shall be a SimpleUnit", nameof(thing));
            }

            if (requestedDataModelVersion < Version.Parse("1.0.0"))
            {
                Logger.Log(LogLevel.Info, "Skipping serialization of SimpleUnit since Version is below 1.0.0");
            ...
            {
                case "1.0.0":
                    Logger.Log(LogLevel.Trace, "Serializing SimpleUnit for Version 1.0.0");

                    //if (simpleUnit.Alias.Count > 0)
                    //{
                        writer.WriteStartArray("alias"u8);

                        foreach(var aliasItem in simpleUnit.Alias.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    writer.WriteStringValue(simpleUnit.ClassKind.ToString());

                    //if (simpleUnit.Definition.Count > 0)
                    //{
                        writer.WriteStartArray("definition"u8);

                        foreach(var definitionItem in simpleUnit.Definition.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    //if (simpleUnit.HyperLink.Count > 0)
                    //{
                        writer.WriteStartArray("hyperLink"u8);

                        foreach(var hyperLinkItem in simpleUnit.HyperLink.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    writer.WriteStringValue(simpleUnit.Iid);
                    writer.WritePropertyName("isDeprecated"u8);
                    writer.WriteBooleanValue(simpleUnit.IsDeprecated);
                    writer.WritePropertyName("name"u8);
                    writer.WriteStringValue(simpleUnit.Name);
                    writer.WritePropertyName("revisionNumber"u8);
                    writer.WriteNumberValue(simpleUnit.RevisionNumber);
                    writer.WritePropertyName("shortName"u8);
                    writer.WriteStringValue(simpleUnit.ShortName);
                    break;
                case "1.1.0":
                    Logger.Log(LogLevel.Trace, "Serializing SimpleUnit for Version 1.1.0");
                    ...
                    //if (simpleUnit.ExcludedDomain.Count > 0)
                    //{
                        writer.WriteStartArray("excludedDomain"u8);

                        foreach(var excludedDomainItem in simpleUnit.ExcludedDomain.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    //if (simpleUnit.ExcludedPerson.Count > 0)
                    //{
                        writer.WriteStartArray("excludedPerson"u8);

                        foreach(var excludedPersonItem in simpleUnit.ExcludedPerson.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    writer.WriteStringValue(simpleUnit.ModifiedOn.ToString(SerializerHelper.DateTimeFormat));
                    writer.WritePropertyName("name"u8);
                    writer.WriteStringValue(simpleUnit.Name);
                    writer.WritePropertyName("revisionNumber"u8);
                    writer.WriteNumberValue(simpleUnit.RevisionNumber);
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Trace, "Serializing SimpleUnit for Version 1.2.0");
                    ...
                    writer.WriteStringValue(simpleUnit.ThingPreference);
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Trace, "Serializing SimpleUnit for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);

                    if(simpleUnit.Actor.HasValue)
                    {
                        writer.WriteStringValue(simpleUnit.Actor.Value);
                    }
                    else
                    {
        ...
        /// <summary>
        /// Serialize a value for a <see cref="SimpleUnit"/> property into a <see cref="Utf8JsonWriter" />
        /// </summary>
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "thingpreference":
                    ...
                    break;
                default:
                    throw new ArgumentException($"The requested property {propertyName} does not exist on the SimpleUnit");
            }
        }
