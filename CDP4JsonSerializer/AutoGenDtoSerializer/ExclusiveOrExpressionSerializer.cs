...
namespace CDP4JsonSerializer
{
    ...
    using ExclusiveOrExpression = CDP4Common.DTO.ExclusiveOrExpression;
    ...
    public class ExclusiveOrExpressionSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        /// <exception cref="ArgumentException">If the provided <paramref name="thing" /> is not an <see cref="ExclusiveOrExpression" /></exception>
        /// <exception cref="NotSupportedException">If the provided <paramref name="requestedDataModelVersion" /> is not supported</exception>
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            if (thing is not ExclusiveOrExpression exclusiveOrExpression)
            {
                throw new ArgumentException("The thing shall be a ExclusiveOrExpression", nameof(thing));
            }

            if (requestedDataModelVersion < Version.Parse("1.0.0"))
            {
                Logger.Log(LogLevel.Info, "Skipping serialization of ExclusiveOrExpression since Version is below 1.0.0");
            ...
            {
                case "1.0.0":
                    Logger.Log(LogLevel.Trace, "Serializing ExclusiveOrExpression for Version 1.0.0");
                ...
                case "1.2.0":
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Trace, "Serializing ExclusiveOrExpression for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);

                    if(exclusiveOrExpression.Actor.HasValue)
                    {
                        writer.WriteStringValue(exclusiveOrExpression.Actor.Value);
                    }
                    else
                    {
        ...
        /// <summary>
        /// Serialize a value for a <see cref="ExclusiveOrExpression"/> property into a <see cref="Utf8JsonWriter" />
        /// </summary>
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "thingpreference":
                    ...
                    break;
                default:
                    throw new ArgumentException($"The requested property {propertyName} does not exist on the ExclusiveOrExpression");
            }
        }
