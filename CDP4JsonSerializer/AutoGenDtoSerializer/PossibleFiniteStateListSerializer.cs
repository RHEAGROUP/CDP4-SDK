...
namespace CDP4JsonSerializer
{
    ...
    public class PossibleFiniteStateListSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            {
                case "1.0.0":
                    Logger.Log(LogLevel.Trace, "Serializing PossibleFiniteStateList for Version 1.0.0");

                    //if (possibleFiniteStateList.Alias.Count > 0)
                    //{
                    ...
                    //if (possibleFiniteStateList.Category.Count > 0)
                    //{
                    ...
                    //if (possibleFiniteStateList.Definition.Count > 0)
                    //{
                    ...
                    //if (possibleFiniteStateList.HyperLink.Count > 0)
                    //{
                    ...
                    //if (possibleFiniteStateList.PossibleState.Count > 0)
                    //{
                    ...
                    break;
                case "1.1.0":
                    Logger.Log(LogLevel.Trace, "Serializing PossibleFiniteStateList for Version 1.1.0");
                    ...
                    //if (possibleFiniteStateList.ExcludedDomain.Count > 0)
                    //{
                    ...
                    //if (possibleFiniteStateList.ExcludedPerson.Count > 0)
                    //{
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Trace, "Serializing PossibleFiniteStateList for Version 1.2.0");
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Trace, "Serializing PossibleFiniteStateList for Version 1.3.0");
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "classkind":
                    ...
                    break;
                case "defaultstate":
                    if(!AllowedVersionsPerProperty["defaultState"].Contains(requestedVersion))
                    {
                        return;
                    }
        ...
        private static readonly IReadOnlyDictionary<string, IReadOnlyCollection<string>> AllowedVersionsPerProperty = new Dictionary<string, IReadOnlyCollection<string>>()
        {
            ...
            { "defaultState", new []{ "1.0.0", "1.1.0", "1.2.0", "1.3.0" }},
