...
namespace CDP4JsonSerializer
{
    ...
    public class ParticipantSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            {
                case "1.0.0":
                    Logger.Log(LogLevel.Trace, "Serializing Participant for Version 1.0.0");
                    ...
                    break;
                case "1.1.0":
                    Logger.Log(LogLevel.Trace, "Serializing Participant for Version 1.1.0");
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(participant.ClassKind.ToString());
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Trace, "Serializing Participant for Version 1.2.0");
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(participant.ClassKind.ToString());
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Trace, "Serializing Participant for Version 1.3.0");
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "role":
                    ...
                    break;
                case "selecteddomain":
                    if(!AllowedVersionsPerProperty["selectedDomain"].Contains(requestedVersion))
                    {
                        return;
                    }
        ...
        private static readonly IReadOnlyDictionary<string, IReadOnlyCollection<string>> AllowedVersionsPerProperty = new Dictionary<string, IReadOnlyCollection<string>>()
        {
            ...
            { "selectedDomain", new []{ "1.0.0", "1.1.0", "1.2.0", "1.3.0" }},
