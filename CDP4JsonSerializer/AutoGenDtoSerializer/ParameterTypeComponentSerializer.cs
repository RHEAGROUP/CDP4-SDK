// -------------------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterTypeComponentSerializer.cs" company="Starion Group S.A.">
...
namespace CDP4JsonSerializer
{
    ...
    public class ParameterTypeComponentSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            {
                case "1.0.0":
                    Logger.Log(LogLevel.Trace, "Serializing ParameterTypeComponent for Version 1.0.0");
                    ...
                    break;
                case "1.1.0":
                    Logger.Log(LogLevel.Trace, "Serializing ParameterTypeComponent for Version 1.1.0");
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(parameterTypeComponent.ClassKind.ToString());

                    if (parameterTypeComponent.ExcludedDomain.Count > 0)
                    {
                    ...
                    if (parameterTypeComponent.ExcludedPerson.Count > 0)
                    {
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Trace, "Serializing ParameterTypeComponent for Version 1.2.0");
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(parameterTypeComponent.ClassKind.ToString());
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Trace, "Serializing ParameterTypeComponent for Version 1.3.0");
