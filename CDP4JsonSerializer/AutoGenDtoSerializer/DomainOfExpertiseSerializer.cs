...
namespace CDP4JsonSerializer
{
    ...
    public class DomainOfExpertiseSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        /// <exception cref="ArgumentException">If the provided <paramref name="thing" /> is not an <see cref="DomainOfExpertise" /></exception>
        /// <exception cref="NotSupportedException">If the provided <paramref name="requestedDataModelVersion" /> is not supported</exception>
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            if (thing is not DomainOfExpertise domainOfExpertise)
            {
                throw new ArgumentException("The thing shall be a DomainOfExpertise", nameof(thing));
            }
            ...
            switch(requestedDataModelVersion.ToString(3))
            {
                case "1.0.0":
                    ...
                    writer.WriteBooleanValue(domainOfExpertise.IsDeprecated);
                    writer.WritePropertyName("name"u8);
                    writer.WriteStringValue(domainOfExpertise.Name);
                    writer.WritePropertyName("revisionNumber"u8);
                    writer.WriteNumberValue(domainOfExpertise.RevisionNumber);
                    writer.WritePropertyName("shortName"u8);
                    writer.WriteStringValue(domainOfExpertise.ShortName);
                    break;
                case "1.1.0":
                    ...
                    writer.WriteStringValue(domainOfExpertise.ModifiedOn.ToString(SerializerHelper.DateTimeFormat));
                    writer.WritePropertyName("name"u8);
                    writer.WriteStringValue(domainOfExpertise.Name);
                    writer.WritePropertyName("revisionNumber"u8);
                    writer.WriteNumberValue(domainOfExpertise.RevisionNumber);
                ...
                case "1.2.0":
                    ...
                    writer.WriteStringValue(domainOfExpertise.ThingPreference);
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Trace, "Serializing DomainOfExpertise for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);

                    if(domainOfExpertise.Actor.HasValue)
                    {
                        writer.WriteStringValue(domainOfExpertise.Actor.Value);
                    }
                    else
                    {
        ...
        /// <summary>
        /// Serialize a value for a <see cref="DomainOfExpertise"/> property into a <see cref="Utf8JsonWriter" />
        /// </summary>
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "thingpreference":
                    ...
                    break;
                default:
                    throw new ArgumentException($"The requested property {propertyName} does not exist on the DomainOfExpertise");
            }
        }
