// -------------------------------------------------------------------------------------------------------------------------------
// <copyright file="CompoundParameterTypeSerializer.cs" company="Starion Group S.A.">
...
namespace CDP4JsonSerializer
{
    ...
    public class CompoundParameterTypeSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        /// <exception cref="ArgumentException">If the provided <paramref name="thing" /> is not an <see cref="CompoundParameterType" /></exception>
        /// <exception cref="NotSupportedException">If the provided <paramref name="requestedDataModelVersion" /> is not supported</exception>
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            if (thing is not CompoundParameterType compoundParameterType)
            {
                throw new ArgumentException("The thing shall be a CompoundParameterType", nameof(thing));
            }
            ...
            switch(requestedDataModelVersion.ToString(3))
            {
                case "1.0.0":
                    ...
                    writer.WriteBooleanValue(compoundParameterType.IsDeprecated);
                    writer.WritePropertyName("isFinalized"u8);
                    writer.WriteBooleanValue(compoundParameterType.IsFinalized);
                    writer.WritePropertyName("name"u8);
                    writer.WriteStringValue(compoundParameterType.Name);
                    writer.WritePropertyName("revisionNumber"u8);
                    writer.WriteNumberValue(compoundParameterType.RevisionNumber);
                    writer.WritePropertyName("shortName"u8);
                    writer.WriteStringValue(compoundParameterType.ShortName);
                    writer.WritePropertyName("symbol"u8);
                    writer.WriteStringValue(compoundParameterType.Symbol);
                    break;
                case "1.1.0":
                    ...
                    writer.WriteStringValue(compoundParameterType.ModifiedOn.ToString(SerializerHelper.DateTimeFormat));
                    writer.WritePropertyName("name"u8);
                    writer.WriteStringValue(compoundParameterType.Name);
                    writer.WritePropertyName("revisionNumber"u8);
                    writer.WriteNumberValue(compoundParameterType.RevisionNumber);
                ...
                case "1.2.0":
                    ...
                    writer.WriteStringValue(compoundParameterType.ThingPreference);
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Trace, "Serializing CompoundParameterType for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);

                    if(compoundParameterType.Actor.HasValue)
                    {
                        writer.WriteStringValue(compoundParameterType.Actor.Value);
                    }
                    else
                    {
        ...
        /// <summary>
        /// Serialize a value for a <see cref="CompoundParameterType"/> property into a <see cref="Utf8JsonWriter" />
        /// </summary>
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "classkind":
                    ...
                    break;
                case "component":
                    if(!AllowedVersionsPerProperty["component"].Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "isdeprecated":
                    ...
                    break;
                case "isfinalized":
                    if(!AllowedVersionsPerProperty["isFinalized"].Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "thingpreference":
                    ...
                    break;
                default:
                    throw new ArgumentException($"The requested property {propertyName} does not exist on the CompoundParameterType");
            }
        }
