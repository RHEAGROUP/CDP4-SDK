// -------------------------------------------------------------------------------------------------------------------------------
// <copyright file="RequirementsSpecificationSerializer.cs" company="Starion Group S.A.">
...
namespace CDP4JsonSerializer
{
    ...
    public class RequirementsSpecificationSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        /// <exception cref="ArgumentException">If the provided <paramref name="thing" /> is not an <see cref="RequirementsSpecification" /></exception>
        /// <exception cref="NotSupportedException">If the provided <paramref name="requestedDataModelVersion" /> is not supported</exception>
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            if (thing is not RequirementsSpecification requirementsSpecification)
            {
                throw new ArgumentException("The thing shall be a RequirementsSpecification", nameof(thing));
            }

            if (requestedDataModelVersion < Version.Parse("1.0.0"))
            {
                Logger.Log(LogLevel.Info, "Skipping serialization of RequirementsSpecification since Version is below 1.0.0");
            ...
            {
                case "1.0.0":
                    Logger.Log(LogLevel.Trace, "Serializing RequirementsSpecification for Version 1.0.0");

                    //if (requirementsSpecification.Alias.Count > 0)
                    //{
                        writer.WriteStartArray("alias"u8);

                        foreach(var aliasItem in requirementsSpecification.Alias.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    writer.WriteStringValue(requirementsSpecification.ClassKind.ToString());

                    //if (requirementsSpecification.Definition.Count > 0)
                    //{
                        writer.WriteStartArray("definition"u8);

                        foreach(var definitionItem in requirementsSpecification.Definition.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    //if (requirementsSpecification.Group.Count > 0)
                    //{
                        writer.WriteStartArray("group"u8);

                        foreach(var groupItem in requirementsSpecification.Group.OrderBy(x => x, this.GuidComparer))
                        {
                            writer.WriteStringValue(groupItem);
                        }
                    ...
                    //if (requirementsSpecification.HyperLink.Count > 0)
                    //{
                        writer.WriteStartArray("hyperLink"u8);

                        foreach(var hyperLinkItem in requirementsSpecification.HyperLink.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    writer.WriteStringValue(requirementsSpecification.Iid);
                    writer.WritePropertyName("isDeprecated"u8);
                    writer.WriteBooleanValue(requirementsSpecification.IsDeprecated);
                    writer.WritePropertyName("name"u8);
                    writer.WriteStringValue(requirementsSpecification.Name);
                    writer.WritePropertyName("owner"u8);
                    writer.WriteStringValue(requirementsSpecification.Owner);

                    //if (requirementsSpecification.Requirement.Count > 0)
                    //{
                        writer.WriteStartArray("requirement"u8);

                        foreach(var requirementItem in requirementsSpecification.Requirement.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    writer.WriteNumberValue(requirementsSpecification.RevisionNumber);
                    writer.WritePropertyName("shortName"u8);
                    writer.WriteStringValue(requirementsSpecification.ShortName);
                    break;
                case "1.1.0":
                    Logger.Log(LogLevel.Trace, "Serializing RequirementsSpecification for Version 1.1.0");
                    ...
                    //if (requirementsSpecification.Category.Count > 0)
                    //{
                        writer.WriteStartArray("category"u8);

                        foreach(var categoryItem in requirementsSpecification.Category.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    //if (requirementsSpecification.ExcludedDomain.Count > 0)
                    //{
                        writer.WriteStartArray("excludedDomain"u8);

                        foreach(var excludedDomainItem in requirementsSpecification.ExcludedDomain.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    //if (requirementsSpecification.ExcludedPerson.Count > 0)
                    //{
                        writer.WriteStartArray("excludedPerson"u8);

                        foreach(var excludedPersonItem in requirementsSpecification.ExcludedPerson.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    writer.WriteStringValue(requirementsSpecification.ModifiedOn.ToString(SerializerHelper.DateTimeFormat));
                    writer.WritePropertyName("name"u8);
                    writer.WriteStringValue(requirementsSpecification.Name);
                    writer.WritePropertyName("owner"u8);
                    writer.WriteStringValue(requirementsSpecification.Owner);

                    //if (requirementsSpecification.ParameterValue.Count > 0)
                    //{
                        writer.WriteStartArray("parameterValue"u8);

                        foreach(var parameterValueItem in requirementsSpecification.ParameterValue.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Trace, "Serializing RequirementsSpecification for Version 1.2.0");
                    ...
                    writer.WriteStringValue(requirementsSpecification.ThingPreference);
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Trace, "Serializing RequirementsSpecification for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);

                    if(requirementsSpecification.Actor.HasValue)
                    {
                        writer.WriteStringValue(requirementsSpecification.Actor.Value);
                    }
                    else
                    {
        ...
        /// <summary>
        /// Serialize a value for a <see cref="RequirementsSpecification"/> property into a <see cref="Utf8JsonWriter" />
        /// </summary>
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "group":
                    ...
                    if (value is IEnumerable<object> objectListGroup && objectListGroup.Any())
                    {
                        writer.WriteStartArray("group"u8);

                        foreach(var groupItem in objectListGroup.OfType<Guid>().OrderBy(x => x, this.GuidComparer))
                        {
                            writer.WriteStringValue(groupItem);
                        }
                        writer.WriteEndArray();
                ...
                case "parametervalue":
                    ...
                    break;
                case "requirement":
                    if(!AllowedVersionsPerProperty["requirement"].Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "thingpreference":
                    ...
                    break;
                default:
                    throw new ArgumentException($"The requested property {propertyName} does not exist on the RequirementsSpecification");
            }
        }
        ...
        private static readonly IReadOnlyDictionary<string, IReadOnlyCollection<string>> AllowedVersionsPerProperty = new Dictionary<string, IReadOnlyCollection<string>>()
        {
            ...
            { "requirement", new []{ "1.0.0", "1.1.0", "1.2.0", "1.3.0" }},
