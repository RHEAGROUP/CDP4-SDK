// -------------------------------------------------------------------------------------------------------------------------------
// <copyright file="StakeholderValueSerializer.cs" company="Starion Group S.A.">
...
namespace CDP4JsonSerializer
{
    ...
    using StakeholderValue = CDP4Common.DTO.StakeholderValue;
    ...
    public class StakeholderValueSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        /// <exception cref="ArgumentException">If the provided <paramref name="thing" /> is not an <see cref="StakeholderValue" /></exception>
        /// <exception cref="NotSupportedException">If the provided <paramref name="requestedDataModelVersion" /> is not supported</exception>
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            if (thing is not StakeholderValue stakeholderValue)
            {
                throw new ArgumentException("The thing shall be a StakeholderValue", nameof(thing));
            }

            if (requestedDataModelVersion < Version.Parse("1.1.0"))
            {
                Logger.Log(LogLevel.Info, "Skipping serialization of StakeholderValue since Version is below 1.1.0");
            ...
            {
                case "1.1.0":
                    Logger.Log(LogLevel.Trace, "Serializing StakeholderValue for Version 1.1.0");

                    //if (stakeholderValue.Alias.Count > 0)
                    //{
                        writer.WriteStartArray("alias"u8);

                        foreach(var aliasItem in stakeholderValue.Alias.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    //if (stakeholderValue.Category.Count > 0)
                    //{
                        writer.WriteStartArray("category"u8);

                        foreach(var categoryItem in stakeholderValue.Category.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    writer.WriteStringValue(stakeholderValue.ClassKind.ToString());

                    //if (stakeholderValue.Definition.Count > 0)
                    //{
                        writer.WriteStartArray("definition"u8);

                        foreach(var definitionItem in stakeholderValue.Definition.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    //if (stakeholderValue.ExcludedDomain.Count > 0)
                    //{
                        writer.WriteStartArray("excludedDomain"u8);

                        foreach(var excludedDomainItem in stakeholderValue.ExcludedDomain.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    //if (stakeholderValue.ExcludedPerson.Count > 0)
                    //{
                        writer.WriteStartArray("excludedPerson"u8);

                        foreach(var excludedPersonItem in stakeholderValue.ExcludedPerson.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    //if (stakeholderValue.HyperLink.Count > 0)
                    //{
                        writer.WriteStartArray("hyperLink"u8);

                        foreach(var hyperLinkItem in stakeholderValue.HyperLink.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    writer.WriteStringValue(stakeholderValue.Iid);
                    writer.WritePropertyName("modifiedOn"u8);
                    writer.WriteStringValue(stakeholderValue.ModifiedOn.ToString(SerializerHelper.DateTimeFormat));
                    writer.WritePropertyName("name"u8);
                    writer.WriteStringValue(stakeholderValue.Name);
                    writer.WritePropertyName("revisionNumber"u8);
                    writer.WriteNumberValue(stakeholderValue.RevisionNumber);
                    writer.WritePropertyName("shortName"u8);
                    writer.WriteStringValue(stakeholderValue.ShortName);
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Trace, "Serializing StakeholderValue for Version 1.2.0");
                    ...
                    writer.WriteStringValue(stakeholderValue.ThingPreference);
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Trace, "Serializing StakeholderValue for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);

                    if(stakeholderValue.Actor.HasValue)
                    {
                        writer.WriteStringValue(stakeholderValue.Actor.Value);
                    }
                    else
                    {
        ...
        /// <summary>
        /// Serialize a value for a <see cref="StakeholderValue"/> property into a <see cref="Utf8JsonWriter" />
        /// </summary>
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "thingpreference":
                    ...
                    break;
                default:
                    throw new ArgumentException($"The requested property {propertyName} does not exist on the StakeholderValue");
            }
        }
