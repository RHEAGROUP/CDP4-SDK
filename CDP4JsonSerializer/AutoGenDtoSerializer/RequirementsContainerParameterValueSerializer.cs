// -------------------------------------------------------------------------------------------------------------------------------
// <copyright file="RequirementsContainerParameterValueSerializer.cs" company="Starion Group S.A.">
...
namespace CDP4JsonSerializer
{
    ...
    public class RequirementsContainerParameterValueSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            {
                case "1.1.0":
                    Logger.Log(LogLevel.Trace, "Serializing RequirementsContainerParameterValue for Version 1.1.0");
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(requirementsContainerParameterValue.ClassKind.ToString());

                    if (requirementsContainerParameterValue.ExcludedDomain.Count > 0)
                    {
                    ...
                    if (requirementsContainerParameterValue.ExcludedPerson.Count > 0)
                    {
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Trace, "Serializing RequirementsContainerParameterValue for Version 1.2.0");
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(requirementsContainerParameterValue.ClassKind.ToString());
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Trace, "Serializing RequirementsContainerParameterValue for Version 1.3.0");
