        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(requestedDataModelVersion.ToString(3))
            {
                ...
                case "1.1.0":
                    ...
                    //if (relationalExpression.ExcludedDomain.Count > 0)
                    //{
                    ...
                    //if (relationalExpression.ExcludedPerson.Count > 0)
                    //{
                ...
                case "1.3.0":
                    ...
                    {
                        writer.WriteStringValue(relationalExpression.Actor.Value);
                    }
                    else
                    {
                        writer.WriteNullValue();
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "relationaloperator":
                    if(!AllowedVersionsPerProperty["relationalOperator"].Contains(requestedVersion))
                    {
                        return;
                    }
