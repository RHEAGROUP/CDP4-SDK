// -------------------------------------------------------------------------------------------------------------------------------
// <copyright file="OrdinalScaleSerializer.cs" company="Starion Group S.A.">
        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(requestedDataModelVersion.ToString(3))
            {
                case "1.0.0":
                    ...
                    //if (ordinalScale.Definition.Count > 0)
                    //{
                    ...
                    //if (ordinalScale.HyperLink.Count > 0)
                    //{
                    ...
                    //if (ordinalScale.MappingToReferenceScale.Count > 0)
                    //{
                    ...
                    //if (ordinalScale.ValueDefinition.Count > 0)
                    //{
                ...
                case "1.1.0":
                    ...
                    //if (ordinalScale.ExcludedDomain.Count > 0)
                    //{
                    ...
                    //if (ordinalScale.ExcludedPerson.Count > 0)
                    //{
