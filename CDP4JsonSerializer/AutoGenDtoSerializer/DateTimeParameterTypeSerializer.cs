        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(requestedDataModelVersion.ToString(3))
            {
                case "1.0.0":
                    ...
                    if (dateTimeParameterType.Alias.Count > 0)
                    {
                    ...
                    if (dateTimeParameterType.Category.Count > 0)
                    {
                    ...
                    if (dateTimeParameterType.Definition.Count > 0)
                    {
                    ...
                    if (dateTimeParameterType.HyperLink.Count > 0)
                    {
                ...
                case "1.1.0":
                    ...
                    if (dateTimeParameterType.ExcludedDomain.Count > 0)
                    {
                    ...
                    if (dateTimeParameterType.ExcludedPerson.Count > 0)
                    {
                ...
                case "1.3.0":
                    ...
                    {
                        writer.WriteStringValue(dateTimeParameterType.Actor.Value);
                    }
                    else
                    {
