        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(requestedDataModelVersion.ToString(3))
            {
                ...
                case "1.3.0":
                    ...
                    {
                        writer.WriteStringValue(color.Actor.Value);
                    }
                    else
                    {
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                case "actor":
                    ...
                    break;
                case "blue":
                    if(!AllowedVersionsPerProperty["blue"].Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "excludedperson":
                    ...
                    break;
                case "green":
                    if(!AllowedVersionsPerProperty["green"].Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "name":
                    ...
                    break;
                case "red":
                    if(!AllowedVersionsPerProperty["red"].Contains(requestedVersion))
                    {
                        return;
                    }
