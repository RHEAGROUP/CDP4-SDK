...
namespace CDP4JsonSerializer
{
    ...
    using BinaryRelationshipRule = CDP4Common.DTO.BinaryRelationshipRule;
    ...
    public class BinaryRelationshipRuleSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        /// <exception cref="ArgumentException">If the provided <paramref name="thing" /> is not an <see cref="BinaryRelationshipRule" /></exception>
        /// <exception cref="NotSupportedException">If the provided <paramref name="requestedDataModelVersion" /> is not supported</exception>
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            if (thing is not BinaryRelationshipRule binaryRelationshipRule)
            {
                throw new ArgumentException("The thing shall be a BinaryRelationshipRule", nameof(thing));
            }
            ...
            switch(requestedDataModelVersion.ToString(3))
            {
                case "1.0.0":
                    ...
                    writer.WritePropertyName("inverseRelationshipName"u8);
                    writer.WriteStringValue(binaryRelationshipRule.InverseRelationshipName);
                    writer.WritePropertyName("isDeprecated"u8);
                    writer.WriteBooleanValue(binaryRelationshipRule.IsDeprecated);
                    writer.WritePropertyName("name"u8);
                    writer.WriteStringValue(binaryRelationshipRule.Name);
                    writer.WritePropertyName("relationshipCategory"u8);
                    writer.WriteStringValue(binaryRelationshipRule.RelationshipCategory);
                    writer.WritePropertyName("revisionNumber"u8);
                    writer.WriteNumberValue(binaryRelationshipRule.RevisionNumber);
                    writer.WritePropertyName("shortName"u8);
                    writer.WriteStringValue(binaryRelationshipRule.ShortName);
                    writer.WritePropertyName("sourceCategory"u8);
                    writer.WriteStringValue(binaryRelationshipRule.SourceCategory);
                    writer.WritePropertyName("targetCategory"u8);
                    writer.WriteStringValue(binaryRelationshipRule.TargetCategory);
                    break;
                case "1.1.0":
                    ...
                    writer.WriteStringValue(binaryRelationshipRule.ModifiedOn.ToString(SerializerHelper.DateTimeFormat));
                    writer.WritePropertyName("name"u8);
                    writer.WriteStringValue(binaryRelationshipRule.Name);
                    writer.WritePropertyName("relationshipCategory"u8);
                    writer.WriteStringValue(binaryRelationshipRule.RelationshipCategory);
                ...
                case "1.2.0":
                    ...
                    writer.WriteStringValue(binaryRelationshipRule.ThingPreference);
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Trace, "Serializing BinaryRelationshipRule for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);

                    if(binaryRelationshipRule.Actor.HasValue)
                    {
                        writer.WriteStringValue(binaryRelationshipRule.Actor.Value);
                    }
                    else
                    {
        ...
        /// <summary>
        /// Serialize a value for a <see cref="BinaryRelationshipRule"/> property into a <see cref="Utf8JsonWriter" />
        /// </summary>
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "inverserelationshipname":
                    if(!AllowedVersionsPerProperty["inverseRelationshipName"].Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "relationshipcategory":
                    if(!AllowedVersionsPerProperty["relationshipCategory"].Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "shortname":
                    ...
                    break;
                case "sourcecategory":
                    if(!AllowedVersionsPerProperty["sourceCategory"].Contains(requestedVersion))
                    {
                        return;
                    }
                    ...
                    break;
                case "targetcategory":
                    if(!AllowedVersionsPerProperty["targetCategory"].Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "thingpreference":
                    ...
                    break;
                default:
                    throw new ArgumentException($"The requested property {propertyName} does not exist on the BinaryRelationshipRule");
            }
        }
        ...
        private static readonly IReadOnlyDictionary<string, IReadOnlyCollection<string>> AllowedVersionsPerProperty = new Dictionary<string, IReadOnlyCollection<string>>()
        {
            ...
            { "forwardRelationshipName", new []{ "1.0.0", "1.1.0", "1.2.0", "1.3.0" }},
            { "hyperLink", new []{ "1.0.0", "1.1.0", "1.2.0", "1.3.0" }},
            { "iid", new []{ "1.0.0", "1.1.0", "1.2.0", "1.3.0" }},
            { "inverseRelationshipName", new []{ "1.0.0", "1.1.0", "1.2.0", "1.3.0" }},
            { "isDeprecated", new []{ "1.0.0", "1.1.0", "1.2.0", "1.3.0" }},
            { "modifiedOn", new []{ "1.1.0", "1.2.0", "1.3.0" }},
            { "name", new []{ "1.0.0", "1.1.0", "1.2.0", "1.3.0" }},
            { "relationshipCategory", new []{ "1.0.0", "1.1.0", "1.2.0", "1.3.0" }},
            { "revisionNumber", new []{ "1.0.0", "1.1.0", "1.2.0", "1.3.0" }},
            { "shortName", new []{ "1.0.0", "1.1.0", "1.2.0", "1.3.0" }},
            { "sourceCategory", new []{ "1.0.0", "1.1.0", "1.2.0", "1.3.0" }},
            { "targetCategory", new []{ "1.0.0", "1.1.0", "1.2.0", "1.3.0" }},
