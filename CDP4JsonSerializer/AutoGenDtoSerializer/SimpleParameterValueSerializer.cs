// -------------------------------------------------------------------------------------------------------------------------------
// <copyright file="SimpleParameterValueSerializer.cs" company="Starion Group S.A.">
...
namespace CDP4JsonSerializer
{
    ...
    using SimpleParameterValue = CDP4Common.DTO.SimpleParameterValue;
    ...
    public class SimpleParameterValueSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            {
                case "1.0.0":
                    Logger.Log(LogLevel.Trace, "Serializing SimpleParameterValue for Version 1.0.0");
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "value":
                    ...
                    break;
                default:
                    throw new ArgumentException($"The requested property {propertyName} does not exist on the SimpleParameterValue");
            }
        }
