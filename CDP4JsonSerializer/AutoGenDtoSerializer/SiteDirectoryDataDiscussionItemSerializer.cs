// -------------------------------------------------------------------------------------------------------------------------------
// <copyright file="SiteDirectoryDataDiscussionItemSerializer.cs" company="Starion Group S.A.">
...
namespace CDP4JsonSerializer
{
    ...
    using SiteDirectoryDataDiscussionItem = CDP4Common.DTO.SiteDirectoryDataDiscussionItem;
    ...
    public class SiteDirectoryDataDiscussionItemSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        /// <exception cref="ArgumentException">If the provided <paramref name="thing" /> is not an <see cref="SiteDirectoryDataDiscussionItem" /></exception>
        /// <exception cref="NotSupportedException">If the provided <paramref name="requestedDataModelVersion" /> is not supported</exception>
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            if (thing is not SiteDirectoryDataDiscussionItem siteDirectoryDataDiscussionItem)
            {
                throw new ArgumentException("The thing shall be a SiteDirectoryDataDiscussionItem", nameof(thing));
            }
            ...
            {
                case "1.1.0":
                    Logger.Log(LogLevel.Trace, "Serializing SiteDirectoryDataDiscussionItem for Version 1.1.0");
                    writer.WritePropertyName("author"u8);
                    writer.WriteStringValue(siteDirectoryDataDiscussionItem.Author);
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(siteDirectoryDataDiscussionItem.ClassKind.ToString());
                    writer.WritePropertyName("content"u8);
                    writer.WriteStringValue(siteDirectoryDataDiscussionItem.Content);
                    ...
                    writer.WriteStringValue(siteDirectoryDataDiscussionItem.LanguageCode);
                    writer.WritePropertyName("modifiedOn"u8);
                    writer.WriteStringValue(siteDirectoryDataDiscussionItem.ModifiedOn.ToString(SerializerHelper.DateTimeFormat));
                    writer.WritePropertyName("replyTo"u8);

                    if(siteDirectoryDataDiscussionItem.ReplyTo.HasValue)
                    {
                        writer.WriteStringValue(siteDirectoryDataDiscussionItem.ReplyTo.Value);
                    }
                    else
                    {
                    ...
                    writer.WriteNumberValue(siteDirectoryDataDiscussionItem.RevisionNumber);
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Trace, "Serializing SiteDirectoryDataDiscussionItem for Version 1.2.0");
                    writer.WritePropertyName("author"u8);
                    writer.WriteStringValue(siteDirectoryDataDiscussionItem.Author);
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(siteDirectoryDataDiscussionItem.ClassKind.ToString());
                    ...
                    writer.WriteStringValue(siteDirectoryDataDiscussionItem.ThingPreference);
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Trace, "Serializing SiteDirectoryDataDiscussionItem for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);

                    if(siteDirectoryDataDiscussionItem.Actor.HasValue)
                    {
                        writer.WriteStringValue(siteDirectoryDataDiscussionItem.Actor.Value);
                    }
                    else
                    {
                        writer.WriteNullValue();
        ...
        /// <summary>
        /// Serialize a value for a <see cref="SiteDirectoryDataDiscussionItem"/> property into a <see cref="Utf8JsonWriter" />
        /// </summary>
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "thingpreference":
                    ...
                    break;
                default:
                    throw new ArgumentException($"The requested property {propertyName} does not exist on the SiteDirectoryDataDiscussionItem");
            }
        }
