        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(requestedDataModelVersion.ToString(3))
            {
                case "1.1.0":
                    ...
                    //if (bounds.ExcludedDomain.Count > 0)
                    //{
                    ...
                    //if (bounds.ExcludedPerson.Count > 0)
                    //{
                ...
                case "1.3.0":
                    ...
                    {
                        writer.WriteStringValue(bounds.Actor.Value);
                    }
                    else
                    {
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "excludedperson":
                    ...
                    break;
                case "height":
                    if(!AllowedVersionsPerProperty["height"].Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "thingpreference":
                    ...
                    break;
                case "width":
                    if(!AllowedVersionsPerProperty["width"].Contains(requestedVersion))
                    {
                        return;
                    }
