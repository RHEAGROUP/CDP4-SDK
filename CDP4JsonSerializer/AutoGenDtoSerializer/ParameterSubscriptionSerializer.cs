// -------------------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterSubscriptionSerializer.cs" company="Starion Group S.A.">
...
namespace CDP4JsonSerializer
{
    ...
    public class ParameterSubscriptionSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        /// <exception cref="ArgumentException">If the provided <paramref name="thing" /> is not an <see cref="ParameterSubscription" /></exception>
        /// <exception cref="NotSupportedException">If the provided <paramref name="requestedDataModelVersion" /> is not supported</exception>
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            if (thing is not ParameterSubscription parameterSubscription)
            {
                throw new ArgumentException("The thing shall be a ParameterSubscription", nameof(thing));
            }
            ...
            {
                case "1.0.0":
                    Logger.Log(LogLevel.Trace, "Serializing ParameterSubscription for Version 1.0.0");
                    ...
                    writer.WriteStringValue(parameterSubscription.Owner);
                    ...
                    break;
                case "1.1.0":
                    Logger.Log(LogLevel.Trace, "Serializing ParameterSubscription for Version 1.1.0");
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(parameterSubscription.ClassKind.ToString());
                    ...
                    writer.WriteStringValue(parameterSubscription.ModifiedOn.ToString(SerializerHelper.DateTimeFormat));
                    writer.WritePropertyName("owner"u8);
                    writer.WriteStringValue(parameterSubscription.Owner);
                    writer.WritePropertyName("revisionNumber"u8);
                    writer.WriteNumberValue(parameterSubscription.RevisionNumber);
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Trace, "Serializing ParameterSubscription for Version 1.2.0");
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(parameterSubscription.ClassKind.ToString());
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Trace, "Serializing ParameterSubscription for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);

                    if(parameterSubscription.Actor.HasValue)
                    {
                        writer.WriteStringValue(parameterSubscription.Actor.Value);
                    }
                    else
                    {
        ...
        /// <summary>
        /// Serialize a value for a <see cref="ParameterSubscription"/> property into a <see cref="Utf8JsonWriter" />
        /// </summary>
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "valueset":
                    ...
                    break;
                default:
                    throw new ArgumentException($"The requested property {propertyName} does not exist on the ParameterSubscription");
            }
        }
