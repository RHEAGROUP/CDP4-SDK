...
namespace CDP4JsonSerializer
{
    ...
    using RuleViolation = CDP4Common.DTO.RuleViolation;
    ...
    public class RuleViolationSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        /// <exception cref="ArgumentException">If the provided <paramref name="thing" /> is not an <see cref="RuleViolation" /></exception>
        /// <exception cref="NotSupportedException">If the provided <paramref name="requestedDataModelVersion" /> is not supported</exception>
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            if (thing is not RuleViolation ruleViolation)
            {
                throw new ArgumentException("The thing shall be a RuleViolation", nameof(thing));
            }

            if (requestedDataModelVersion < Version.Parse("1.0.0"))
            {
                Logger.Log(LogLevel.Info, "Skipping serialization of RuleViolation since Version is below 1.0.0");
                return;
            }
            ...
            {
                case "1.0.0":
                    Logger.Log(LogLevel.Trace, "Serializing RuleViolation for Version 1.0.0");
                    ...
                    break;
                case "1.1.0":
                    Logger.Log(LogLevel.Trace, "Serializing RuleViolation for Version 1.1.0");
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(ruleViolation.ClassKind.ToString());
                    writer.WritePropertyName("description"u8);
                    writer.WriteStringValue(ruleViolation.Description);
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Trace, "Serializing RuleViolation for Version 1.2.0");
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(ruleViolation.ClassKind.ToString());
                    writer.WritePropertyName("description"u8);
                    writer.WriteStringValue(ruleViolation.Description);
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Trace, "Serializing RuleViolation for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);

                    if(ruleViolation.Actor.HasValue)
                    {
                        writer.WriteStringValue(ruleViolation.Actor.Value);
                    }
                    else
                    {
        ...
        /// <summary>
        /// Serialize a value for a <see cref="RuleViolation"/> property into a <see cref="Utf8JsonWriter" />
        /// </summary>
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "thingpreference":
                    ...
                    break;
                case "violatingthing":
                    if(!AllowedVersionsPerProperty["violatingThing"].Contains(requestedVersion))
                    {
                        return;
                    }
        ...
        private static readonly IReadOnlyDictionary<string, IReadOnlyCollection<string>> AllowedVersionsPerProperty = new Dictionary<string, IReadOnlyCollection<string>>()
        {
            ...
            { "violatingThing", new []{ "1.0.0", "1.1.0", "1.2.0", "1.3.0" }},
        };
    }
}
