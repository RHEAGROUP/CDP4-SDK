// -------------------------------------------------------------------------------------------------------------------------------
// <copyright file="DecompositionRuleSerializer.cs" company="Starion Group S.A.">
...
namespace CDP4JsonSerializer
{
    ...
    using DecompositionRule = CDP4Common.DTO.DecompositionRule;
    ...
    public class DecompositionRuleSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        /// <exception cref="ArgumentException">If the provided <paramref name="thing" /> is not an <see cref="DecompositionRule" /></exception>
        /// <exception cref="NotSupportedException">If the provided <paramref name="requestedDataModelVersion" /> is not supported</exception>
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            if (thing is not DecompositionRule decompositionRule)
            {
                throw new ArgumentException("The thing shall be a DecompositionRule", nameof(thing));
            }
            ...
            switch(requestedDataModelVersion.ToString(3))
            {
                case "1.0.0":
                    ...
                    if (decompositionRule.ContainedCategory.Count > 0)
                    {
                        ...
                        {
                            writer.WriteStringValue(containedCategoryItem);
                        }
                    ...
                    writer.WriteBooleanValue(decompositionRule.IsDeprecated);
                    writer.WritePropertyName("maxContained"u8);

                    if(decompositionRule.MaxContained.HasValue)
                    {
                        writer.WriteNumberValue(decompositionRule.MaxContained.Value);
                    }
                    else
                    {
                    ...
                    writer.WritePropertyName("minContained"u8);
                    writer.WriteNumberValue(decompositionRule.MinContained);
                    writer.WritePropertyName("name"u8);
                    writer.WriteStringValue(decompositionRule.Name);
                    writer.WritePropertyName("revisionNumber"u8);
                    writer.WriteNumberValue(decompositionRule.RevisionNumber);
                    writer.WritePropertyName("shortName"u8);
                    writer.WriteStringValue(decompositionRule.ShortName);
                    break;
                case "1.1.0":
                    ...
                    writer.WriteStringValue(decompositionRule.ModifiedOn.ToString(SerializerHelper.DateTimeFormat));
                    writer.WritePropertyName("name"u8);
                    writer.WriteStringValue(decompositionRule.Name);
                    writer.WritePropertyName("revisionNumber"u8);
                    writer.WriteNumberValue(decompositionRule.RevisionNumber);
                ...
                case "1.2.0":
                    ...
                    writer.WriteStringValue(decompositionRule.ThingPreference);
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Trace, "Serializing DecompositionRule for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);

                    if(decompositionRule.Actor.HasValue)
                    {
                        writer.WriteStringValue(decompositionRule.Actor.Value);
                    }
                    else
                    {
                        writer.WriteNullValue();
        ...
        /// <summary>
        /// Serialize a value for a <see cref="DecompositionRule"/> property into a <see cref="Utf8JsonWriter" />
        /// </summary>
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "containedcategory":
                    ...
                    if (value is IEnumerable<object> objectListContainedCategory && objectListContainedCategory.Any())
                    {
                        ...
                        foreach(var containedCategoryItem in objectListContainedCategory.OfType<Guid>().OrderBy(x => x, this.GuidComparer))
                        {
                            writer.WriteStringValue(containedCategoryItem);
                        }
                        writer.WriteEndArray();
                ...
                case "containingcategory":
                    if(!AllowedVersionsPerProperty["containingCategory"].Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "isdeprecated":
                    ...
                    break;
                case "maxcontained":
                    if(!AllowedVersionsPerProperty["maxContained"].Contains(requestedVersion))
                    {
                        return;
                    }
                    ...
                    break;
                case "mincontained":
                    if(!AllowedVersionsPerProperty["minContained"].Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "thingpreference":
                    ...
                    break;
                default:
                    throw new ArgumentException($"The requested property {propertyName} does not exist on the DecompositionRule");
            }
        }
        ...
        private static readonly IReadOnlyDictionary<string, IReadOnlyCollection<string>> AllowedVersionsPerProperty = new Dictionary<string, IReadOnlyCollection<string>>()
        {
            ...
            { "containedCategory", new []{ "1.0.0", "1.1.0", "1.2.0", "1.3.0" }},
            { "containingCategory", new []{ "1.0.0", "1.1.0", "1.2.0", "1.3.0" }},
            ...
            { "maxContained", new []{ "1.0.0", "1.1.0", "1.2.0", "1.3.0" }},
            { "minContained", new []{ "1.0.0", "1.1.0", "1.2.0", "1.3.0" }},
