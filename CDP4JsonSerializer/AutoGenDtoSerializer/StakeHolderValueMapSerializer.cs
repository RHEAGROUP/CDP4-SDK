...
namespace CDP4JsonSerializer
{
    ...
    using StakeHolderValueMap = CDP4Common.DTO.StakeHolderValueMap;
    ...
    public class StakeHolderValueMapSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        /// <exception cref="ArgumentException">If the provided <paramref name="thing" /> is not an <see cref="StakeHolderValueMap" /></exception>
        /// <exception cref="NotSupportedException">If the provided <paramref name="requestedDataModelVersion" /> is not supported</exception>
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            if (thing is not StakeHolderValueMap stakeHolderValueMap)
            {
                throw new ArgumentException("The thing shall be a StakeHolderValueMap", nameof(thing));
            }

            if (requestedDataModelVersion < Version.Parse("1.1.0"))
            {
                Logger.Log(LogLevel.Info, "Skipping serialization of StakeHolderValueMap since Version is below 1.1.0");
            ...
            switch(requestedDataModelVersion.ToString(3))
            {
                ...
                case "1.2.0":
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Trace, "Serializing StakeHolderValueMap for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);

                    if(stakeHolderValueMap.Actor.HasValue)
                    {
                        writer.WriteStringValue(stakeHolderValueMap.Actor.Value);
                    }
                    else
                    {
        ...
        /// <summary>
        /// Serialize a value for a <see cref="StakeHolderValueMap"/> property into a <see cref="Utf8JsonWriter" />
        /// </summary>
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "revisionnumber":
                    ...
                    break;
                case "settings":
                    if(!AllowedVersionsPerProperty["settings"].Contains(requestedVersion))
                    {
                        return;
                    }
        ...
        private static readonly IReadOnlyDictionary<string, IReadOnlyCollection<string>> AllowedVersionsPerProperty = new Dictionary<string, IReadOnlyCollection<string>>()
        {
            ...
            { "requirement", new []{ "1.1.0", "1.2.0", "1.3.0" }},
            { "revisionNumber", new []{ "1.1.0", "1.2.0", "1.3.0" }},
            { "settings", new []{ "1.1.0", "1.2.0", "1.3.0" }},
