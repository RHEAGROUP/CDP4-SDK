// -------------------------------------------------------------------------------------------------------------------------------
// <copyright file="TimeOfDayParameterTypeSerializer.cs" company="Starion Group S.A.">
...
namespace CDP4JsonSerializer
{
    ...
    public class TimeOfDayParameterTypeSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        /// <exception cref="ArgumentException">If the provided <paramref name="thing" /> is not an <see cref="TimeOfDayParameterType" /></exception>
        /// <exception cref="NotSupportedException">If the provided <paramref name="requestedDataModelVersion" /> is not supported</exception>
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            if (thing is not TimeOfDayParameterType timeOfDayParameterType)
            {
                throw new ArgumentException("The thing shall be a TimeOfDayParameterType", nameof(thing));
            }

            if (requestedDataModelVersion < Version.Parse("1.0.0"))
            {
                Logger.Log(LogLevel.Info, "Skipping serialization of TimeOfDayParameterType since Version is below 1.0.0");
            ...
            {
                case "1.0.0":
                    Logger.Log(LogLevel.Trace, "Serializing TimeOfDayParameterType for Version 1.0.0");

                    //if (timeOfDayParameterType.Alias.Count > 0)
                    //{
                        writer.WriteStartArray("alias"u8);

                        foreach(var aliasItem in timeOfDayParameterType.Alias.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    //if (timeOfDayParameterType.Category.Count > 0)
                    //{
                        writer.WriteStartArray("category"u8);

                        foreach(var categoryItem in timeOfDayParameterType.Category.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    writer.WriteStringValue(timeOfDayParameterType.ClassKind.ToString());

                    //if (timeOfDayParameterType.Definition.Count > 0)
                    //{
                        writer.WriteStartArray("definition"u8);

                        foreach(var definitionItem in timeOfDayParameterType.Definition.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    //if (timeOfDayParameterType.HyperLink.Count > 0)
                    //{
                        writer.WriteStartArray("hyperLink"u8);

                        foreach(var hyperLinkItem in timeOfDayParameterType.HyperLink.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    writer.WriteStringValue(timeOfDayParameterType.Iid);
                    writer.WritePropertyName("isDeprecated"u8);
                    writer.WriteBooleanValue(timeOfDayParameterType.IsDeprecated);
                    writer.WritePropertyName("name"u8);
                    writer.WriteStringValue(timeOfDayParameterType.Name);
                    writer.WritePropertyName("revisionNumber"u8);
                    writer.WriteNumberValue(timeOfDayParameterType.RevisionNumber);
                    writer.WritePropertyName("shortName"u8);
                    writer.WriteStringValue(timeOfDayParameterType.ShortName);
                    writer.WritePropertyName("symbol"u8);
                    writer.WriteStringValue(timeOfDayParameterType.Symbol);
                    break;
                case "1.1.0":
                    Logger.Log(LogLevel.Trace, "Serializing TimeOfDayParameterType for Version 1.1.0");
                    ...
                    //if (timeOfDayParameterType.ExcludedDomain.Count > 0)
                    //{
                        writer.WriteStartArray("excludedDomain"u8);

                        foreach(var excludedDomainItem in timeOfDayParameterType.ExcludedDomain.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    //if (timeOfDayParameterType.ExcludedPerson.Count > 0)
                    //{
                        writer.WriteStartArray("excludedPerson"u8);

                        foreach(var excludedPersonItem in timeOfDayParameterType.ExcludedPerson.OrderBy(x => x, this.GuidComparer))
                        {
                    ...
                    writer.WriteStringValue(timeOfDayParameterType.ModifiedOn.ToString(SerializerHelper.DateTimeFormat));
                    writer.WritePropertyName("name"u8);
                    writer.WriteStringValue(timeOfDayParameterType.Name);
                    writer.WritePropertyName("revisionNumber"u8);
                    writer.WriteNumberValue(timeOfDayParameterType.RevisionNumber);
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Trace, "Serializing TimeOfDayParameterType for Version 1.2.0");
                    ...
                    writer.WriteStringValue(timeOfDayParameterType.ThingPreference);
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Trace, "Serializing TimeOfDayParameterType for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);

                    if(timeOfDayParameterType.Actor.HasValue)
                    {
                        writer.WriteStringValue(timeOfDayParameterType.Actor.Value);
                    }
                    else
                    {
        ...
        /// <summary>
        /// Serialize a value for a <see cref="TimeOfDayParameterType"/> property into a <see cref="Utf8JsonWriter" />
        /// </summary>
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "thingpreference":
                    ...
                    break;
                default:
                    throw new ArgumentException($"The requested property {propertyName} does not exist on the TimeOfDayParameterType");
            }
        }
