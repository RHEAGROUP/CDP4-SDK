        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(requestedDataModelVersion.ToString(3))
            {
                case "1.0.0":
                    ...
                    if (referenceSource.Alias.Count > 0)
                    {
                    ...
                    if (referenceSource.Category.Count > 0)
                    {
                    ...
                    if (referenceSource.Definition.Count > 0)
                    {
                    ...
                    if (referenceSource.HyperLink.Count > 0)
                    {
                ...
                case "1.1.0":
                    ...
                    if (referenceSource.ExcludedDomain.Count > 0)
                    {
                    ...
                    if (referenceSource.ExcludedPerson.Count > 0)
                    {
                ...
                case "1.3.0":
                    ...
                    {
                        writer.WriteStringValue(referenceSource.Actor.Value);
                    }
                    else
                    {
                        writer.WriteNullValue();
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "isdeprecated":
                    ...
                    break;
                case "language":
                    if(!AllowedVersionsPerProperty["language"].Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "publicationyear":
                    if(!AllowedVersionsPerProperty["publicationYear"].Contains(requestedVersion))
                    {
                        return;
                    }
                    ...
                    break;
                case "publishedin":
                    if(!AllowedVersionsPerProperty["publishedIn"].Contains(requestedVersion))
                    {
                        return;
                    }
                    ...
                    break;
                case "publisher":
                    if(!AllowedVersionsPerProperty["publisher"].Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "thingpreference":
                    ...
                    break;
                case "versiondate":
                    if(!AllowedVersionsPerProperty["versionDate"].Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "versionidentifier":
                    if(!AllowedVersionsPerProperty["versionIdentifier"].Contains(requestedVersion))
                    {
                        return;
                    }
