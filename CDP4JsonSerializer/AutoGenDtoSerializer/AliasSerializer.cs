// -------------------------------------------------------------------------------------------------------------------------------
// <copyright file="AliasSerializer.cs" company="Starion Group S.A.">
...
namespace CDP4JsonSerializer
{
    ...
    public class AliasSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        /// <exception cref="ArgumentException">If the provided <paramref name="thing" /> is not an <see cref="Alias" /></exception>
        /// <exception cref="NotSupportedException">If the provided <paramref name="requestedDataModelVersion" /> is not supported</exception>
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            if (thing is not Alias alias)
            {
                throw new ArgumentException("The thing shall be a Alias", nameof(thing));
            }
            ...
            {
                case "1.0.0":
                    Logger.Log(LogLevel.Trace, "Serializing Alias for Version 1.0.0");
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(alias.ClassKind.ToString());
                    writer.WritePropertyName("content"u8);
                    writer.WriteStringValue(alias.Content);
                    writer.WritePropertyName("iid"u8);
                    writer.WriteStringValue(alias.Iid);
                    writer.WritePropertyName("isSynonym"u8);
                    writer.WriteBooleanValue(alias.IsSynonym);
                    writer.WritePropertyName("languageCode"u8);
                    writer.WriteStringValue(alias.LanguageCode);
                    writer.WritePropertyName("revisionNumber"u8);
                    writer.WriteNumberValue(alias.RevisionNumber);
                    break;
                case "1.1.0":
                    Logger.Log(LogLevel.Trace, "Serializing Alias for Version 1.1.0");
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(alias.ClassKind.ToString());
                    writer.WritePropertyName("content"u8);
                    writer.WriteStringValue(alias.Content);
                    ...
                    writer.WriteStringValue(alias.ModifiedOn.ToString(SerializerHelper.DateTimeFormat));
                    writer.WritePropertyName("revisionNumber"u8);
                    writer.WriteNumberValue(alias.RevisionNumber);
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Trace, "Serializing Alias for Version 1.2.0");
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(alias.ClassKind.ToString());
                    writer.WritePropertyName("content"u8);
                    writer.WriteStringValue(alias.Content);
                    ...
                    writer.WriteStringValue(alias.ThingPreference);
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Trace, "Serializing Alias for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);

                    if(alias.Actor.HasValue)
                    {
                        writer.WriteStringValue(alias.Actor.Value);
                    }
                    else
                    {
        ...
        /// <summary>
        /// Serialize a value for a <see cref="Alias"/> property into a <see cref="Utf8JsonWriter" />
        /// </summary>
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "iid":
                    ...
                    break;
                case "issynonym":
                    if(!AllowedVersionsPerProperty["isSynonym"].Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "thingpreference":
                    ...
                    break;
                default:
                    throw new ArgumentException($"The requested property {propertyName} does not exist on the Alias");
            }
        }
        ...
        private static readonly IReadOnlyDictionary<string, IReadOnlyCollection<string>> AllowedVersionsPerProperty = new Dictionary<string, IReadOnlyCollection<string>>()
        {
            ...
            { "isSynonym", new []{ "1.0.0", "1.1.0", "1.2.0", "1.3.0" }},
