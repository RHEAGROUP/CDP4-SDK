        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(requestedDataModelVersion.ToString(3))
            {
                case "1.0.0":
                    ...
                    if (fileRevision.FileType.Count > 0)
                    {
                ...
                case "1.1.0":
                    ...
                    if (fileRevision.ExcludedDomain.Count > 0)
                    {
                    ...
                    if (fileRevision.ExcludedPerson.Count > 0)
                    {
                ...
                case "1.3.0":
                    ...
                    {
                        writer.WriteStringValue(fileRevision.Actor.Value);
                    }
                    else
                    {
                        writer.WriteNullValue();
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "containingfolder":
                    ...
                    break;
                case "contenthash":
                    if(!AllowedVersionsPerProperty["contentHash"].Contains(requestedVersion))
                    {
                        return;
                    }
