// -------------------------------------------------------------------------------------------------------------------------------
// <copyright file="FolderSerializer.cs" company="Starion Group S.A.">
...
namespace CDP4JsonSerializer
{
    ...
    public class FolderSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            {
                case "1.0.0":
                    Logger.Log(LogLevel.Trace, "Serializing Folder for Version 1.0.0");
                    ...
                    break;
                case "1.1.0":
                    Logger.Log(LogLevel.Trace, "Serializing Folder for Version 1.1.0");
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(folder.ClassKind.ToString());
                    writer.WritePropertyName("containingFolder"u8);
                    ...
                    if (folder.ExcludedDomain.Count > 0)
                    {
                    ...
                    if (folder.ExcludedPerson.Count > 0)
                    {
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Trace, "Serializing Folder for Version 1.2.0");
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(folder.ClassKind.ToString());
                    writer.WritePropertyName("containingFolder"u8);
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Trace, "Serializing Folder for Version 1.3.0");
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "containingfolder":
                    if(!AllowedVersionsPerProperty["containingFolder"].Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "createdon":
                    ...
                    break;
                case "creator":
                    if(!AllowedVersionsPerProperty["creator"].Contains(requestedVersion))
                    {
                        return;
                    }
