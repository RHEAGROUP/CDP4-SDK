...
namespace CDP4JsonSerializer
{
    ...
    /// <summary>
    /// The purpose of the <see cref="EmailAddressResolver"/> is to deserialize a JSON object to a <see cref="CDP4Common.DTO.EmailAddress"/>
    /// </summary>
    public static class EmailAddressResolver
    {
        ...
        /// <returns>The <see cref="CDP4Common.DTO.EmailAddress"/> to instantiate</returns>
        public static CDP4Common.DTO.EmailAddress FromJsonObject(JsonElement jsonElement)
        {
            if (!jsonElement.TryGetProperty("iid"u8, out var iid))
            {
                throw new DeSerializationException("the mandatory iid property is not available, the EmailAddressResolver cannot be used to deserialize this JsonElement");
            }
            ...
            var emailAddress = new CDP4Common.DTO.EmailAddress(iid.GetGuid(), revisionNumberValue);
