...
namespace CDP4JsonSerializer
{
    ...
    public static class ChangeRequestResolver
    {
        ...
        public static CDP4Common.DTO.ChangeRequest FromJsonObject(JsonElement jsonElement)
        {
            ...
            var changeRequest = new CDP4Common.DTO.ChangeRequest(iid.GetGuid(), revisionNumberValue);
            ...
            if (jsonElement.TryGetProperty("author"u8, out var authorProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale author property of the changeRequest {id} is null", changeRequest.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("classification"u8, out var classificationProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale classification property of the changeRequest {id} is null", changeRequest.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("content"u8, out var contentProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale content property of the changeRequest {id} is null", changeRequest.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("createdOn"u8, out var createdOnProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale createdOn property of the changeRequest {id} is null", changeRequest.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("languageCode"u8, out var languageCodeProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale languageCode property of the changeRequest {id} is null", changeRequest.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("modifiedOn"u8, out var modifiedOnProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale modifiedOn property of the changeRequest {id} is null", changeRequest.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("owner"u8, out var ownerProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale owner property of the changeRequest {id} is null", changeRequest.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("shortName"u8, out var shortNameProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale shortName property of the changeRequest {id} is null", changeRequest.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("status"u8, out var statusProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale status property of the changeRequest {id} is null", changeRequest.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("thingPreference"u8, out var thingPreferenceProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale thingPreference property of the changeRequest {id} is null", changeRequest.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("title"u8, out var titleProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale title property of the changeRequest {id} is null", changeRequest.Iid);
                }
                else
                {
