...
namespace CDP4JsonSerializer
{
    ...
    public static class SectionResolver
    {
        ...
        public static CDP4Common.DTO.Section FromJsonObject(JsonElement jsonElement)
        {
            ...
            var section = new CDP4Common.DTO.Section(iid.GetGuid(), revisionNumberValue);
            ...
            if (jsonElement.TryGetProperty("createdOn"u8, out var createdOnProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale createdOn property of the section {id} is null", section.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("modifiedOn"u8, out var modifiedOnProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale modifiedOn property of the section {id} is null", section.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("name"u8, out var nameProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale name property of the section {id} is null", section.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("owner"u8, out var ownerProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale owner property of the section {id} is null", section.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("shortName"u8, out var shortNameProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale shortName property of the section {id} is null", section.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("thingPreference"u8, out var thingPreferenceProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale thingPreference property of the section {id} is null", section.Iid);
                }
                else
                {
