...
namespace CDP4JsonSerializer
{
    ...
    /// <summary>
    /// The purpose of the <see cref="TextualNoteResolver"/> is to deserialize a JSON object to a <see cref="CDP4Common.DTO.TextualNote"/>
    /// </summary>
    public static class TextualNoteResolver
    {
        ...
        /// <summary>
        /// Instantiate and deserialize the properties of a <see cref="CDP4Common.DTO.TextualNote"/>
        /// </summary>
        /// <param name="jsonElement">The <see cref="JsonElement"/> containing the data</param>
        /// <returns>The <see cref="CDP4Common.DTO.TextualNote"/> to instantiate</returns>
        public static CDP4Common.DTO.TextualNote FromJsonObject(JsonElement jsonElement)
        {
            if (!jsonElement.TryGetProperty("iid"u8, out var iid))
            {
                throw new DeSerializationException("the mandatory iid property is not available, the TextualNoteResolver cannot be used to deserialize this JsonElement");
            }
            ...
            var textualNote = new CDP4Common.DTO.TextualNote(iid.GetGuid(), revisionNumberValue);
