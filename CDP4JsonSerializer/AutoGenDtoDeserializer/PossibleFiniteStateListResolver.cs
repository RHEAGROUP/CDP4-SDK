...
namespace CDP4JsonSerializer
{
    ...
    /// <summary>
    /// The purpose of the <see cref="PossibleFiniteStateListResolver"/> is to deserialize a JSON object to a <see cref="CDP4Common.DTO.PossibleFiniteStateList"/>
    /// </summary>
    public static class PossibleFiniteStateListResolver
    {
        ...
        /// <summary>
        /// Instantiate and deserialize the properties of a <see cref="CDP4Common.DTO.PossibleFiniteStateList"/>
        /// </summary>
        /// <param name="jsonElement">The <see cref="JsonElement"/> containing the data</param>
        /// <returns>The <see cref="CDP4Common.DTO.PossibleFiniteStateList"/> to instantiate</returns>
        public static CDP4Common.DTO.PossibleFiniteStateList FromJsonObject(JsonElement jsonElement)
        {
            if (!jsonElement.TryGetProperty("iid"u8, out var iid))
            {
                throw new DeSerializationException("the mandatory iid property is not available, the PossibleFiniteStateListResolver cannot be used to deserialize this JsonElement");
            }
            ...
            var possibleFiniteStateList = new CDP4Common.DTO.PossibleFiniteStateList(iid.GetGuid(), revisionNumberValue);
