...
namespace CDP4JsonSerializer
{
    ...
    public static class LogarithmicScaleResolver
    {
        ...
        public static CDP4Common.DTO.LogarithmicScale FromJsonObject(JsonElement jsonElement)
        {
            ...
            var logarithmicScale = new CDP4Common.DTO.LogarithmicScale(iid.GetGuid(), revisionNumberValue);
            ...
            if (jsonElement.TryGetProperty("exponent"u8, out var exponentProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale exponent property of the logarithmicScale {id} is null", logarithmicScale.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("factor"u8, out var factorProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale factor property of the logarithmicScale {id} is null", logarithmicScale.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("isDeprecated"u8, out var isDeprecatedProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale isDeprecated property of the logarithmicScale {id} is null", logarithmicScale.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("isMaximumInclusive"u8, out var isMaximumInclusiveProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale isMaximumInclusive property of the logarithmicScale {id} is null", logarithmicScale.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("isMinimumInclusive"u8, out var isMinimumInclusiveProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale isMinimumInclusive property of the logarithmicScale {id} is null", logarithmicScale.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("logarithmBase"u8, out var logarithmBaseProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale logarithmBase property of the logarithmicScale {id} is null", logarithmicScale.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("maximumPermissibleValue"u8, out var maximumPermissibleValueProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale maximumPermissibleValue property of the logarithmicScale {id} is null", logarithmicScale.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("minimumPermissibleValue"u8, out var minimumPermissibleValueProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale minimumPermissibleValue property of the logarithmicScale {id} is null", logarithmicScale.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("modifiedOn"u8, out var modifiedOnProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale modifiedOn property of the logarithmicScale {id} is null", logarithmicScale.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("name"u8, out var nameProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale name property of the logarithmicScale {id} is null", logarithmicScale.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("negativeValueConnotation"u8, out var negativeValueConnotationProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale negativeValueConnotation property of the logarithmicScale {id} is null", logarithmicScale.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("numberSet"u8, out var numberSetProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale numberSet property of the logarithmicScale {id} is null", logarithmicScale.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("positiveValueConnotation"u8, out var positiveValueConnotationProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale positiveValueConnotation property of the logarithmicScale {id} is null", logarithmicScale.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("referenceQuantityKind"u8, out var referenceQuantityKindProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale referenceQuantityKind property of the logarithmicScale {id} is null", logarithmicScale.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("shortName"u8, out var shortNameProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale shortName property of the logarithmicScale {id} is null", logarithmicScale.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("thingPreference"u8, out var thingPreferenceProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale thingPreference property of the logarithmicScale {id} is null", logarithmicScale.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("unit"u8, out var unitProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale unit property of the logarithmicScale {id} is null", logarithmicScale.Iid);
                }
                else
                {
