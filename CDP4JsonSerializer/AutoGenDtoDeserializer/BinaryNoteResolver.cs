    ...
    public static class BinaryNoteResolver
    {
        ...
        public static CDP4Common.DTO.BinaryNote FromJsonObject(JsonElement jsonElement)
        {
            ...
            if (jsonElement.TryGetProperty("caption"u8, out var captionProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale caption property of the binaryNote {id} is null", binaryNote.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("createdOn"u8, out var createdOnProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale createdOn property of the binaryNote {id} is null", binaryNote.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("fileType"u8, out var fileTypeProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale fileType property of the binaryNote {id} is null", binaryNote.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("modifiedOn"u8, out var modifiedOnProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale modifiedOn property of the binaryNote {id} is null", binaryNote.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("name"u8, out var nameProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale name property of the binaryNote {id} is null", binaryNote.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("owner"u8, out var ownerProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale owner property of the binaryNote {id} is null", binaryNote.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("shortName"u8, out var shortNameProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale shortName property of the binaryNote {id} is null", binaryNote.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("thingPreference"u8, out var thingPreferenceProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale thingPreference property of the binaryNote {id} is null", binaryNote.Iid);
                }
                else
                {
