...
namespace CDP4JsonSerializer
{
    ...
    public static class RequestForWaiverResolver
    {
        ...
        public static CDP4Common.DTO.RequestForWaiver FromJsonObject(JsonElement jsonElement)
        {
            ...
            var requestForWaiver = new CDP4Common.DTO.RequestForWaiver(iid.GetGuid(), revisionNumberValue);
            ...
            if (jsonElement.TryGetProperty("classification"u8, out var classificationProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale classification property of the requestForWaiver {id} is null", requestForWaiver.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("content"u8, out var contentProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale content property of the requestForWaiver {id} is null", requestForWaiver.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("modifiedOn"u8, out var modifiedOnProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale modifiedOn property of the requestForWaiver {id} is null", requestForWaiver.Iid);
                }
                else
                {
