...
namespace CDP4JsonSerializer
{
    ...
    /// <summary>
    /// The purpose of the <see cref="FileTypeResolver"/> is to deserialize a JSON object to a <see cref="CDP4Common.DTO.FileType"/>
    /// </summary>
    public static class FileTypeResolver
    {
        ...
        /// <summary>
        /// Instantiate and deserialize the properties of a <see cref="CDP4Common.DTO.FileType"/>
        /// </summary>
        /// <param name="jsonElement">The <see cref="JsonElement"/> containing the data</param>
        /// <returns>The <see cref="CDP4Common.DTO.FileType"/> to instantiate</returns>
        public static CDP4Common.DTO.FileType FromJsonObject(JsonElement jsonElement)
        {
            if (!jsonElement.TryGetProperty("iid"u8, out var iid))
            {
                throw new DeSerializationException("the mandatory iid property is not available, the FileTypeResolver cannot be used to deserialize this JsonElement");
            }
            ...
            if (jsonElement.TryGetProperty("category"u8, out var categoryProperty) && categoryProperty.ValueKind != JsonValueKind.Null)
            {
                ...
                {
                    fileType.Category.Add(element.GetGuid());
                }
            }
            ...
            if (jsonElement.TryGetProperty("definition"u8, out var definitionProperty) && definitionProperty.ValueKind != JsonValueKind.Null)
            {
                ...
                {
                    fileType.Definition.Add(element.GetGuid());
                }
            }
            ...
            if (jsonElement.TryGetProperty("excludedDomain"u8, out var excludedDomainProperty) && excludedDomainProperty.ValueKind != JsonValueKind.Null)
            {
                ...
                {
                    fileType.ExcludedDomain.Add(element.GetGuid());
                }
            }
            ...
            if (jsonElement.TryGetProperty("excludedPerson"u8, out var excludedPersonProperty) && excludedPersonProperty.ValueKind != JsonValueKind.Null)
            {
                ...
                {
                    fileType.ExcludedPerson.Add(element.GetGuid());
                }
            }

            if (jsonElement.TryGetProperty("extension"u8, out var extensionProperty))
            {
                ...
                {
                    fileType.Extension = extensionProperty.GetString();
                }
            }
            ...
            if (jsonElement.TryGetProperty("hyperLink"u8, out var hyperLinkProperty) && hyperLinkProperty.ValueKind != JsonValueKind.Null)
            {
                ...
                {
                    fileType.HyperLink.Add(element.GetGuid());
                }
            }
            ...
            if (jsonElement.TryGetProperty("isDeprecated"u8, out var isDeprecatedProperty))
            {
                ...
                {
                    fileType.IsDeprecated = isDeprecatedProperty.GetBoolean();
                }
            }
            ...
            if (jsonElement.TryGetProperty("modifiedOn"u8, out var modifiedOnProperty))
            {
                ...
                {
                    fileType.ModifiedOn = modifiedOnProperty.GetDateTime();
                }
            }
            ...
            if (jsonElement.TryGetProperty("name"u8, out var nameProperty))
            {
                ...
                {
                    fileType.Name = nameProperty.GetString();
                }
            }
            ...
            if (jsonElement.TryGetProperty("shortName"u8, out var shortNameProperty))
            {
                ...
                {
                    fileType.ShortName = shortNameProperty.GetString();
                }
            }
            ...
            if (jsonElement.TryGetProperty("thingPreference"u8, out var thingPreferenceProperty))
            {
                ...
                {
                    fileType.ThingPreference = thingPreferenceProperty.GetString();
                }
            }
