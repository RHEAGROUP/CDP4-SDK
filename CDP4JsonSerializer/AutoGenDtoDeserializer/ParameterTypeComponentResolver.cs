    ...
    public static class ParameterTypeComponentResolver
    {
        ...
        public static CDP4Common.DTO.ParameterTypeComponent FromJsonObject(JsonElement jsonElement)
        {
            ...
            if (jsonElement.TryGetProperty("modifiedOn"u8, out var modifiedOnProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale modifiedOn property of the parameterTypeComponent {id} is null", parameterTypeComponent.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("parameterType"u8, out var parameterTypeProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale parameterType property of the parameterTypeComponent {id} is null", parameterTypeComponent.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("shortName"u8, out var shortNameProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale shortName property of the parameterTypeComponent {id} is null", parameterTypeComponent.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("thingPreference"u8, out var thingPreferenceProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale thingPreference property of the parameterTypeComponent {id} is null", parameterTypeComponent.Iid);
                }
                else
                {
