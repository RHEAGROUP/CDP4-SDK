...
namespace CDP4JsonSerializer
{
    ...
    /// <summary>
    /// The purpose of the <see cref="OrExpressionResolver"/> is to deserialize a JSON object to a <see cref="CDP4Common.DTO.OrExpression"/>
    /// </summary>
    public static class OrExpressionResolver
    {
        ...
        /// <summary>
        /// Instantiate and deserialize the properties of a <see cref="CDP4Common.DTO.OrExpression"/>
        /// </summary>
        /// <param name="jsonElement">The <see cref="JsonElement"/> containing the data</param>
        /// <returns>The <see cref="CDP4Common.DTO.OrExpression"/> to instantiate</returns>
        public static CDP4Common.DTO.OrExpression FromJsonObject(JsonElement jsonElement)
        {
            if (!jsonElement.TryGetProperty("iid"u8, out var iid))
            {
                throw new DeSerializationException("the mandatory iid property is not available, the OrExpressionResolver cannot be used to deserialize this JsonElement");
            }
            ...
            var orExpression = new CDP4Common.DTO.OrExpression(iid.GetGuid(), revisionNumberValue);
