...
namespace CDP4JsonSerializer
{
    ...
    /// <summary>
    /// The purpose of the <see cref="RuleVerificationListResolver"/> is to deserialize a JSON object to a <see cref="CDP4Common.DTO.RuleVerificationList"/>
    /// </summary>
    public static class RuleVerificationListResolver
    {
        ...
        /// <summary>
        /// Instantiate and deserialize the properties of a <see cref="CDP4Common.DTO.RuleVerificationList"/>
        /// </summary>
        /// <param name="jsonElement">The <see cref="JsonElement"/> containing the data</param>
        /// <returns>The <see cref="CDP4Common.DTO.RuleVerificationList"/> to instantiate</returns>
        public static CDP4Common.DTO.RuleVerificationList FromJsonObject(JsonElement jsonElement)
        {
            if (!jsonElement.TryGetProperty("iid"u8, out var iid))
            {
                throw new DeSerializationException("the mandatory iid property is not available, the RuleVerificationListResolver cannot be used to deserialize this JsonElement");
            }
            ...
            var ruleVerificationList = new CDP4Common.DTO.RuleVerificationList(iid.GetGuid(), revisionNumberValue);
