...
namespace CDP4JsonSerializer
{
    ...
    /// <summary>
    /// The purpose of the <see cref="SiteDirectoryDataAnnotationResolver"/> is to deserialize a JSON object to a <see cref="CDP4Common.DTO.SiteDirectoryDataAnnotation"/>
    /// </summary>
    public static class SiteDirectoryDataAnnotationResolver
    {
        ...
        /// <summary>
        /// Instantiate and deserialize the properties of a <see cref="CDP4Common.DTO.SiteDirectoryDataAnnotation"/>
        /// </summary>
        /// <param name="jsonElement">The <see cref="JsonElement"/> containing the data</param>
        /// <returns>The <see cref="CDP4Common.DTO.SiteDirectoryDataAnnotation"/> to instantiate</returns>
        public static CDP4Common.DTO.SiteDirectoryDataAnnotation FromJsonObject(JsonElement jsonElement)
        {
            if (!jsonElement.TryGetProperty("iid"u8, out var iid))
            {
                throw new DeSerializationException("the mandatory iid property is not available, the SiteDirectoryDataAnnotationResolver cannot be used to deserialize this JsonElement");
            }
            ...
            var siteDirectoryDataAnnotation = new CDP4Common.DTO.SiteDirectoryDataAnnotation(iid.GetGuid(), revisionNumberValue);

            if (jsonElement.TryGetProperty("author"u8, out var authorProperty))
            {
                if(authorProperty.ValueKind == JsonValueKind.Null)
                {
                    Logger.Trace("The non-nullabale author property of the siteDirectoryDataAnnotation {id} is null", siteDirectoryDataAnnotation.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("content"u8, out var contentProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale content property of the siteDirectoryDataAnnotation {id} is null", siteDirectoryDataAnnotation.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("createdOn"u8, out var createdOnProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale createdOn property of the siteDirectoryDataAnnotation {id} is null", siteDirectoryDataAnnotation.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("languageCode"u8, out var languageCodeProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale languageCode property of the siteDirectoryDataAnnotation {id} is null", siteDirectoryDataAnnotation.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("modifiedOn"u8, out var modifiedOnProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale modifiedOn property of the siteDirectoryDataAnnotation {id} is null", siteDirectoryDataAnnotation.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("primaryAnnotatedThing"u8, out var primaryAnnotatedThingProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale primaryAnnotatedThing property of the siteDirectoryDataAnnotation {id} is null", siteDirectoryDataAnnotation.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("thingPreference"u8, out var thingPreferenceProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale thingPreference property of the siteDirectoryDataAnnotation {id} is null", siteDirectoryDataAnnotation.Iid);
                }
                else
                {
