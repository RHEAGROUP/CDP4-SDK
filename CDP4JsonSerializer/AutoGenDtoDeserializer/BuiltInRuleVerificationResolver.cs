...
namespace CDP4JsonSerializer
{
    ...
    public static class BuiltInRuleVerificationResolver
    {
        ...
        public static CDP4Common.DTO.BuiltInRuleVerification FromJsonObject(JsonElement jsonElement)
        {
            ...
            var builtInRuleVerification = new CDP4Common.DTO.BuiltInRuleVerification(iid.GetGuid(), revisionNumberValue);
            ...
            if (jsonElement.TryGetProperty("isActive"u8, out var isActiveProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale isActive property of the builtInRuleVerification {id} is null", builtInRuleVerification.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("modifiedOn"u8, out var modifiedOnProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale modifiedOn property of the builtInRuleVerification {id} is null", builtInRuleVerification.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("name"u8, out var nameProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale name property of the builtInRuleVerification {id} is null", builtInRuleVerification.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("status"u8, out var statusProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale status property of the builtInRuleVerification {id} is null", builtInRuleVerification.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("thingPreference"u8, out var thingPreferenceProperty))
            {
                ...
                {
                    Logger.Trace("The non-nullabale thingPreference property of the builtInRuleVerification {id} is null", builtInRuleVerification.Iid);
                }
                else
                {
